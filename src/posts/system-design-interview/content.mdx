...
<img src="./assets/interview-process.png" alt="System design interview process" className="w-full my-6 rounded" />
...
<img src="./assets/scaling-strategies.png" alt="Horizontal vs vertical scaling" className="w-full my-6 rounded" />
...
<img src="./assets/database-patterns.png" alt="Database design patterns" className="w-full my-6 rounded" />
...
<img src="./assets/caching-layers.png" alt="Multi-layer caching architecture" className="w-full my-6 rounded" />
...
<img src="./assets/interview-tips.png" alt="System design interview tips" className="w-full my-6 rounded" />
