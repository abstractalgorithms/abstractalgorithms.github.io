...
if (-not $SkipBuild) {
    Write-Success "✅ Build process works correctly"
}
...
Write-Host ""
Write-Status "PowerShell script options:"
Write-Host "• Test without build: .\scripts\test-deployment.ps1 -SkipBuild"
Write-Host "• Full test: .\scripts\test-deployment.ps1"
