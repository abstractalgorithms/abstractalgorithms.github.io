...
coverImage: "./assets/terraform-architecture.png"
---

# Learning Terraform: A Comprehensive Learning Series

<img src="./assets/terraform-architecture.png" alt="Terraform architecture diagram" class="w-full my-6 rounded" />
...
<img src="./assets/modules.png" alt="Terraform modules diagram" class="w-full my-6 rounded" />
