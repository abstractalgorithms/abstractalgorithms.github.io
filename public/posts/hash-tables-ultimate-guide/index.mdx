...
<img src="./assets/components.png" alt="Hash table components" class="w-full my-6 rounded" />
...
<img src="/linear-probing.png" alt="Linear probing illustration" class="w-full my-6 rounded" />
