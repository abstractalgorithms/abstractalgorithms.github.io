...
coverImage: "./assets/littles-law-flow.png"
---

# Little's Law: Queueing Theory in Practice

<img src="./assets/littles-law-flow.png" alt="Little's Law flowchart" class="w-full my-6 rounded" />
...
<img src="./assets/queue-example.png" alt="Queueing example" class="w-full my-6 rounded" />
