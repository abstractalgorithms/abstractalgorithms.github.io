...
<img src="./assets/overview.png" alt="Big O Notation illustration" class="w-full my-6 rounded" />
...
<img src="./assets/complexity-table.png" alt="Complexity chart" class="w-full my-6 rounded" />
